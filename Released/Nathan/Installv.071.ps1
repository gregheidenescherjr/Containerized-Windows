...
#If anything comes from this project. No I am not certified. I got bored and said, "Lets try something...", 
...
#A supervisor who lacked intelligence... a (ret)CW3... currently working at Ft Gordon... 
#Had his soldiers to create a username and password email address... on deployment... for his Certification test...
#I found out later, but still... He discredited any certification in exsistance by obtaining without true knowledge...
#So yes, it is always good to learn something... And learn it...
#A natrual curiosity is not something you can pay for... like college, or certifications...
#This is how you build leaders for tomorrow... Show them how to start, once they walk... 
#Let them grow and surpass you, ask them how they did it, and see if you can improve the method.
#And most of all, share the method knowing others will one day surpass you... again...

#If serving is beneathe you, Leading is beyong you... 
#(Matthew S. M. you didn't see how fast your methods and ideology destroyed teams, and it was overly obvious you wanted attention and nothing more. 
#So you claimed work as your own, and underminded any true expertise.)

#Before I forget...
#What is Windows IOT? Is is x64 compatiable? I have a stupid idea...Lets try it out anyway...
#Oh yeah.. what ever happen to TENS Linux? That should have had more attention...
...
#Self writing script to lower resources?
