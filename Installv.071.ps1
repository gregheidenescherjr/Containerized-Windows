...
#A Supervisor asked me to create a username and password email address... on deployment... for his CASP test...
...
#(Matthew S. M. you didn't see how fast your methods and ideology destroyed a team, and it was overly obvious you wanted attention and nothing more. 
